...
public class BaseDatos implements Serializable {
    ...
    private void valoresPorDefecto() {
        ...
        compradores.add(new Comprador(1L, "Pedro", "Moreno", "pedro@example.com", Membresia.ORO,124));
        compradores.add(new Comprador(2L, "Ana", "López", "ana@example.com", Membresia.PLATA,257));
        compradores.add(new Comprador(3L, "Juan", "Gómez", "juan@example.com", Membresia.BASICA,312));
        compradores.add(new Comprador(4L, "María", "Rodríguez", "maria@example.com", Membresia.BRONCE,84));
        compradores.add(new Comprador(5L, "Sofía", "Martínez", "sofia@example.com", Membresia.NINGUNA,125));
        compradores.add(new Comprador(6L, "Carlos", "Pérez", "carlos@example.com", Membresia.ORO,245));
        compradores.add(new Comprador(7L, "Laura", "Fernández", "laura@example.com", Membresia.PLATA,123));
        compradores.add(new Comprador(8L, "Diego", "Hernández", "diego@example.com", Membresia.BASICA,45));
        compradores.add(new Comprador(9L, "Isabel", "Díaz", "isabel@example.com", Membresia.BRONCE,23));
        compradores.add(new Comprador(10L, "Luis", "García", "luis@example.com", Membresia.NINGUNA,56));
        compradores.add(new Comprador(11L, "Alejandro", "González", "alejandro@example.com", Membresia.ORO,13));
        compradores.add(new Comprador(12L, "Elena", "Torres", "elena@example.com", Membresia.PLATA,22));
        compradores.add(new Comprador(13L, "Miguel", "Ruiz", "miguel@example.com", Membresia.BASICA,56));
        compradores.add(new Comprador(14L, "Carmen", "Sánchez", "carmen@example.com", Membresia.BRONCE,98));
        compradores.add(new Comprador(15L, "Andrea", "Lara", "andrea@example.com", Membresia.NINGUNA,199));
        compradores.add(new Comprador(16L, "Ricardo", "Vargas", "ricardo@example.com", Membresia.ORO,35));
        compradores.add(new Comprador(17L, "Natalia", "Pérez", "natalia@example.com", Membresia.PLATA,340));
        compradores.add(new Comprador(18L, "Daniel", "Gómez", "daniel@example.com", Membresia.BASICA,56));
        compradores.add(new Comprador(19L, "Lucía", "Hernández", "lucia@example.com", Membresia.BRONCE,11));
        compradores.add(new Comprador(20L, "Javier", "Soto", "javier@example.com", Membresia.NINGUNA,90));
        compradores.add(new Comprador(21L, "Natalia", "López", "natalia@example.com", Membresia.PLATA,434));
        compradores.add(new Comprador(22L, "Pablo", "Martínez", "pablo@example.com", Membresia.BASICA,559));
        compradores.add(new Comprador(23L, "Valeria", "Gutiérrez", "valeria@example.com", Membresia.BRONCE,168));
        compradores.add(new Comprador(24L, "Sara", "Jiménez", "sara@example.com", Membresia.NINGUNA,79));
        compradores.add(new Comprador(25L, "Juan", "Torres", "juan@example.com", Membresia.ORO,67));
        compradores.add(new Comprador(26L, "María", "Gómez", "maria@example.com", Membresia.PLATA,12));
        compradores.add(new Comprador(27L, "Lucas", "Díaz", "lucas@example.com", Membresia.BASICA,235));
        compradores.add(new Comprador(28L, "Valentina", "Fernández", "valentina@example.com", Membresia.BRONCE,92));
        compradores.add(new Comprador(29L, "Gabriel", "Pérez", "gabriel@example.com", Membresia.NINGUNA,56));
        compradores.add(new Comprador(30L, "Sofía", "Moreno", "sofia@example.com", Membresia.ORO,86));
